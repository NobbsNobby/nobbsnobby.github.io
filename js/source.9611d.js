...
var v1 = __webpack_require__(159);
var v4 = __webpack_require__(160);
...
var _App = _interopRequireDefault(__webpack_require__(150));
...
*/
var aa=__webpack_require__(6),ba=__webpack_require__(1),m=__webpack_require__(142),p=__webpack_require__(5),v=__webpack_require__(8),da=__webpack_require__(143),ea=__webpack_require__(144),fa=__webpack_require__(145),ha=__webpack_require__(7);
...
var _Scheduler = _interopRequireDefault(__webpack_require__(153));
...
var _Task = _interopRequireDefault(__webpack_require__(154));

var _Spinner = _interopRequireDefault(__webpack_require__(167));

var _Checkbox = _interopRequireDefault(__webpack_require__(10));

var _stylesM = _interopRequireDefault(__webpack_require__(170));

var _instruments = __webpack_require__(11);

var _reactFlipMove = _interopRequireDefault(__webpack_require__(172));

var _uuid = __webpack_require__(135);

var _REST = __webpack_require__(173);
...
class Scheduler extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_getAllCompleted", () => this.state.tasks.every(task => task.completed));

    _defineProperty(this, "_setTasksFetchingState", state => {
      this.setState({
    ...
    _defineProperty(this, "_updateTaskAsync", async updateTask => {
      try {
        const tasksData = await _REST.api.updateTask(updateTask);
        ...
        this.setState(({
          ...
          tasks: tasks.map(task => {
            return task.id === tasksData[0].id ? tasksData[0] : task;
          })
        }));
      } catch (e) {
        console.log(e.message);
    ...
    _defineProperty(this, "_completeAllTasksAsync", async () => {
      try {
        ...
        await _REST.api.completeAllTasks(this.state.tasks);
        this.setState(({
          tasks
        }) => ({
    ...
    _defineProperty(this, "_removeTask", id => {
      this.setState(({
        tasks
      }) => ({
        tasks: tasks.filter(task => task.id !== id)
    ...
    _defineProperty(this, "_taskArrayFilter", el => {
      const {
        tasksFilter
      } = this.state;
  ...
  render() {
    ...
    const tasksJSX = (0, _instruments.sortTasksByGroup)(tasks.filter(this._taskArrayFilter)).map(task => _react.default.createElement(_Task.default, _extends({
      key: task.id
    }, task, {
    ...
    }, _react.default.createElement("main", null, _react.default.createElement(_Spinner.default, {
      isSpinning: isTasksFetching
    }), _react.default.createElement("header", null, _react.default.createElement("h1", null, "\u041F\u043B\u0430\u043D\u0438\u0440\u043E\u0432\u0449\u0438\u043A \u0437\u0430\u0434\u0430\u0447"), _react.default.createElement("input", {
      maxLength: 50,
      placeholder: "\u041F\u043E\u0438\u0441\u043A",
      type: "search",
      value: tasksFilter,
    ...
    }), _react.default.createElement("button", null, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u0434\u0430\u0447\u0443")), _react.default.createElement("div", null, _react.default.createElement("ul", null, _react.default.createElement(_reactFlipMove.default, null, tasksJSX)))), _react.default.createElement("footer", null, _react.default.createElement(_Checkbox.default, {
...
var _Star = _interopRequireDefault(__webpack_require__(161));

var _Edit = _interopRequireDefault(__webpack_require__(162));

var _Remove = _interopRequireDefault(__webpack_require__(163));

var _stylesM = _interopRequireDefault(__webpack_require__(164));

var _classnames = _interopRequireDefault(__webpack_require__(166));
...
class Task extends _react.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "_setTaskEditingState", status => {
      this.setState({
  ...
  render() {
    ...
    const completedClass = (0, _classnames.default)(_stylesM.default.task, {
...
var rng = __webpack_require__(136);
...
var _stylesM = _interopRequireDefault(__webpack_require__(168));
...
const Spinner = ({
  isSpinning
}) => isSpinning && _react.default.createElement("div", {
...
const api = {
  ...
  async completeAllTasks(tasks) {
    ...
    for (const item of tasks) {
      fetchArr.push(fetch(_config.MAIN_URL, {
        method: 'PUT',
        headers: {
          Authorization: _config.TOKEN,
          'Content-Type': 'application/json'
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.9611d.js.map